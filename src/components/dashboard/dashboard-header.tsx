  ...
  return (
    <div className="hidden lg:flex h-16 items-center justify-between px-4">
      ...
      <div className="flex-1 max-w-2xl mx-8">
        <div className="relative">
          <input 
            ...
            className="w-full bg-muted border border-input rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#14F195]"
          />
      ...
      <div className="flex items-center gap-4">
        <ThemeToggle />
        {balance !== null && (
          <Button variant="ghost" className="flex items-center gap-2 px-4 py-2 bg-muted rounded-full border border-input">
            <Image 
              src="/sol.svg"
              alt="SOL"
              width={16}
      ...
      <Popover>
        ...
        <PopoverContent className="w-80 mt-2" align="end">
          <div className="space-y-4">
            ...
            {balance !== null && (
              <Button variant="ghost" className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-muted rounded-full border border-input">
                <Image 
                  src="/sol.svg"
                  alt="SOL"
                  width={16}
